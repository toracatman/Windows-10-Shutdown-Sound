================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MyApplication プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MyApplication には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MyApplication アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
MyApplication.h
   ...
   CMyApplicationApp アプリケーション クラスを宣言します。

MyApplication.cpp
   これは、アプリケーション クラス CMyApplicationApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\MyApplication.ico
   ...
   アイコンはメイン リソース ファイル MyApplication.rc に含まれていま
   す。
...
MyApplicationDlg.h, MyApplicationDlg.cpp - ダイアログ
   これらのファイルは CMyApplicationDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MyApplication.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MyApplication.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
